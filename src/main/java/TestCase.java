...
public class TestCase  {
    ...
    @BeforeSuite
    void PreSetup() {
        htmlReporter = new ExtentHtmlReporter("SeleniumD&RAssignmentReport.html");
    ...
    void Setup() {
        ...
        test = extent.createTest("DRserJourney", "ValidUserLoggedInSearchForSamsungMobilePhoneAndAddtoBasket");
        WebDriverManager.chromedriver().setup();
        driver = new ChromeDriver();
        driver.manage().window().maximize();
        Log.info("D&R Is Opening");
        driver.get("https://www.dr.com.tr/");
        Assert.assertEquals(driver.getCurrentUrl(), "https://www.dr.com.tr/");
        test.pass("D&R Home Page Opened Successfully");
    ...
    void UserJourney() {
        ...
        Assert.assertEquals("TEST USER", homePage.getLoggedInUseFullName());
